...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="relative flex min-h-[120vh] shrink-0 scale-[0.65] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-[0.75] md:min-h-[200vh] md:scale-100 md:py-80"
    >
      <motion.h2
